...
* горизонтальный скролл в логе обычный, а не узкий красивый.
* фон лога билда на экране build details на мобильной версии имеет отступ от края экрана. А на макете он примыкает. 
